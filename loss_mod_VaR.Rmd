...
junior.plot.1 <- plot(lossvector.1/maxloss, junior.tranche.1)
senior.plot.1 <- plot(lossvector.1/maxloss, senior.tranche.1)
...
junior.plot.5 <- plot(lossvector.5/maxloss, junior.tranche.5)
senior.plot.5 <- plot(lossvector.5/maxloss, senior.tranche.5)
```
