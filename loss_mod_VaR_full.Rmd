...
# Create loss matrix
nvals.1 <- firstloss.1[firstloss.1>0]
...
# Plot VaR Values
pl.95.1 <- ggplot() + geom_density(mapping=aes(x=loss.var95.1)) + xlab("VaR") + ylab("Density") + ggtitle("Parametric 1-year VaR (95%)") + coord_cartesian(xlim=c(36000000,38000000))
pl.95.1
ggsave("par_var_195.png", pl.95.1)
pl.99.1 <- ggplot() + geom_density(mapping=aes(x=loss.var99.1)) + xlab("VaR") + ylab("Density") + ggtitle("Parametric 1-year VaR (99%)") + coord_cartesian(xlim=c(36000000,38000000))
pl.99.1
...
# Create loss matrix
nvals.5 <- firstloss.5[firstloss.5>0]
...
# Plot VaR curves
pl.95.5 <- ggplot() + geom_density(mapping=aes(x=loss.var95.5)) + xlab("VaR") + ylab("Density") + ggtitle("Parametric 5-year VaR (95%)") + coord_cartesian(xlim=c(37150000, 37250000))
pl.95.5
ggsave("par_var_595.png", pl.95.5)

pl.99.5 <- ggplot() + geom_density(mapping=aes(x=loss.var99.5)) + xlab("VaR") + ylab("Density") + ggtitle("Parametric 5-year VaR (99%)") + coord_cartesian(xlim=c(37150000, 37250000))
pl.99.5
...
# Create loss matrix
np.nvals.1 <- np.firstloss.1[np.firstloss.1>0]
...
# Plot VaR Values
np.pl.95.1 <- ggplot() + geom_density(mapping=aes(x=np.loss.var95.1)) + xlab("VaR") + ylab("Density") + ggtitle("Non-parametric 1-year VaR (95%)")
np.pl.95.1
ggsave("np_var_195.png", np.pl.95.1)

np.pl.99.1 <- ggplot() + geom_density(mapping=aes(x=np.loss.var99.1)) + xlab("VaR") + ylab("Density") + ggtitle("Non-parametric 1-year VaR (99%)")
np.pl.99.1
...
# Create loss matrix
np.nvals.5 <- np.firstloss.5[np.firstloss.5>0]
...
# Plot VaR curves
np.pl.95.5 <- ggplot() + geom_density(mapping=aes(x=np.loss.var95.5))+ xlab("VaR") + ylab("Density") + ggtitle("Non-parametric 5-year VaR (95%)")
np.pl.95.5
ggsave("np_var_595.png", np.pl.95.5)

np.pl.99.5 <- ggplot() + geom_density(mapping=aes(x=np.loss.var99.5)) + xlab("VaR") + ylab("Density") + ggtitle("Non-parametric 5-year VaR (99%)") + coord_cartesian(xlim=c(30460000, 30960600))
np.pl.99.5
