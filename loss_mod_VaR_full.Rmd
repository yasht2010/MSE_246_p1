...
var.99.1.sd <- c(avar.99.1-2.57*var.99.1.sd, avar.99.1+2.57*var.99.1.sd)
...
pl.99.5 <- ggplot() + geom_density(mapping=aes(x=(loss.var99.5/maxloss))) + xlab("VaR") + ylab("Density") + ggtitle("Parametric 5-year VaR (99%)") + coord_cartesian(xlim=c(37150000, 37250000))
pl.99.5
...
var.99.5.sd <- c(avar.99.5-2.57*var.99.5.sd, avar.99.5+2.57*var.99.5.sd)
...
np.var.99.1.sd <- c(np.avar.99.1-2.57*np.var.99.1.sd, np.avar.99.1+2.57*np.var.99.1.sd)
...
np.var.99.5.sd <- c(np.avar.99.5-2.57*np.var.99.5.sd, np.avar.99.5+2.57*np.var.99.5.sd)
