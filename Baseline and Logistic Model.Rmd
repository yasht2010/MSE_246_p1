...
test500_1yr = filter(test500_full, ApprovalFiscalYear == start)
...
vaiable importance for baseline
```{r}
...
# test500
pred_log_reg_1yr_test500=predict(log_reg_1yr,test500_1yr,type="response")

pred1yr_test500 = prediction(pred_log_reg_1yr_test500, test500_1yr$isDefault)
